...
![Задание 4](image1/4.png){#fig:004 width=70%}
...
![Задание 5](image1/5.png){#fig:005 width=70%}
...
![Задание 6](image1/6.png){#fig:006 width=70%}
...
![Задание 7](image1/7.png){#fig:007 width=70%}
...
![Задание 8](image1/8.png){#fig:008 width=70%}

![Задание 8](image1/9.png){#fig:009 width=70%}
...
![Задание 9](image1/10.png){#fig:010 width=70%}
...
![Задание 19](image1/21.png){#fig:021 width=70%}
...
![Задание 22](image1/25.png){#fig:024 width=70%}

-q
--quiet
    Turn off Wget's output. 

![Задание 23](image1/26.png){#fig:025 width=70%}
...
![Задание 24](image1/27.png){#fig:026 width=70%}

![Задание 25](image1/28.png){#fig:027 width=70%}

gzip (сокращение от GNU Zip) — утилита сжатия и восстановления (декомпрессии) файлов, использующая алгоритм Deflate.

![Задание 26](image1/29.png){#fig:028 width=70%}
...
![Задание 27](image1/30.png){#fig:029 width=70%}
...
![Задание 28](image1/31.png){#fig:030 width=70%}

Регистр - маленькая буква, слово - `world`, а не `word`

![Задание 29](image1/32.png){#fig:031 width=70%}

![Задание 29](image1/33.png){#fig:032 width=70%}
